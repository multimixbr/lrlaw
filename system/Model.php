...
class Model extends BaseModel
{
    ...
    public function __construct(?ConnectionInterface $db = null, ?ValidationInterface $validation = null)
    {
        ...
        // Se a tabela estiver definida, carregar automaticamente os campos permitidos
        if (isset($this->table) && !empty($this->table)) {
            try {
                $this->allowedFields = $this->db->getFieldNames($this->table);
            } catch (\Exception $e) {
                // Trate o erro, se necessário, caso a tabela não exista ou ocorra outro problema
                log_message('error', 'Erro ao carregar os campos da tabela: ' . $e->getMessage());
            }
        }
