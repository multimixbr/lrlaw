        ...
        <div class="container-fluid mt-5">
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('pessoas/pessoasControllers/filtrar') ?>" method="GET">
                        <div class="row g-3">
                            <!-- ID da Pessoa -->
                            <div class="col-md-2">
                            ...
                            <?php if (!empty($pessoas)) { ?>
                                <?php foreach ($pessoas as $pessoa) { ?>
                                    <tr>
                                        ...
                                        <td><?= $pessoa->email ?></td>
                                        <td>
                                            <a href="<?= base_url('pessoas/pessoasControllers/editar/' . $pessoa->id_pessoa) ?>" class="btn btn-primary btn-sm">Editar</a>
                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm" onclick="confirmarExclusao('<?= base_url('pessoas/pessoasControllers/excluir/' . $pessoa->id_pessoa) ?>')">Excluir</a>
                                            <a href="<?= base_url('pessoas/pessoasControllers/visualizar/' . $pessoa->id_pessoa) ?>" class="btn btn-warning btn-sm">Visualizar</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            <?php } else { ?>
